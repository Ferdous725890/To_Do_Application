    ...
    return (
      <div className='bg-[#1a0b2e] text-white'>
          ...
          className=" w-full p-6 lg:p-9">
            <div className="flex justify-between gap-[30px] flex-wrap w-full bg-[#1a0b2e] ">
                ...
                <div className="">
                    ...
                    <div className="flex gap-[2px] flex-col text-text relative">
                        ...
                        <button
                            className="px-4 h-[61%] rounded-r-md bg-primary text-white absolute top-[24px] right-0">Submit
                        </button>
                    </div>
                </div>
            </div>
            ...
            <img className="w-[120px]" src="https://i.ibb.co.com/XVnJ0dv/1e3f54f3-a1b0-425b-9f0e-c8494b5164a2.png" alt="" />
